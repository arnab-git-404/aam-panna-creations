...
const XConfig = {
  ...
  colors: [0xffd700, 0xffa500, 0xffb6c1],
  ...
  materialParams: {
    // metalness: 0.1,
    metalness: isMobile ? 0.5 : 0.5,
    roughness: isMobile ? 0.5 : 0.5,
    clearcoat: isMobile ? 0 : 1,
    clearcoatRoughness: isMobile ? 0.5 : 0.15,
  },
  minSize: 0.5,
  maxSize: 1,
  size0: 1,
  // gravity: 0.5,
  gravity: isMobile ? 0 : 0.5,

  // friction: 0.9975,
  friction: isMobile ? 0.1 : 0.9975,
  
  wallBounce: 0.95,
  
  // maxVelocity: 0.15,
  maxVelocity: isMobile ? 0.15 : 0.15,
  maxX: 5,
  maxY: 5,
  maxZ: 2,
...
//   materialParams: {
//     // metalness: 0.1,
//     metalness: isMobile ? 0.1 : 0.5,
//     roughness: isMobile ? 0.9 : 0.5,
//     clearcoat: isMobile ? 0 : 1,
//     clearcoatRoughness: isMobile ? 0.5 : 0.15,
//   },
//   minSize: 0.5,
...
//   // friction: 0.9975,
//   friction: isMobile ? 0.995 : 0.9975,
...
//       // Modified touch event handling for mobile scroll
//       document.body.addEventListener("touchstart", onTouchStart as EventListener, {
//         passive: true, // Changed from false to true to allow scrolling
//       });
//       document.body.addEventListener("touchmove", onTouchMove as EventListener, {
//         passive: true, // Changed from false to true to allow scrolling
//       });
...
//   // MODIFIED: Changed canvas touch styles for mobile scrolling
//   if (isMobile) {
//     canvas.style.touchAction = "pan-y"; // Allow vertical scrolling on mobile
//   } else {
//     canvas.style.touchAction = "none"; // Prevent touch interactions on desktop
//   }
//   canvas.style.userSelect = "none";
//   (canvas.style as any).webkitUserSelect = "none";
